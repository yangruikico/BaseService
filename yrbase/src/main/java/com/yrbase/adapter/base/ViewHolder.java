package com.yrbase.adapter.base;
...
import com.yrbase.utils.ImageUtil;
...
public class ViewHolder extends RecyclerView.ViewHolder {
    ...
    public ViewHolder setFonds(int viewId, String fond) {
        TextView textView = getView(viewId);
        if (textView != null) {
            ViewUtil.setFonts(fond, textView);
        }
        return this;
    }
    ...
    public ViewHolder setImage(int viewId, String url) {
        ImageView view = getView(viewId);
        if (view != null) ImageUtil.displayCenterCrop(view, url);
        return this;
    }

    public ViewHolder setImage(int viewId, Bitmap url) {
        ImageView view = getView(viewId);
        if (view != null && url != null) view.setImageBitmap(url);
        return this;
    }

    public ViewHolder setImage(int viewId, String url, int placeHolder, int errorRes) {
        ImageView view = getView(viewId);
        if (view != null) ImageUtil.displayCenterCrop(view, url, placeHolder, errorRes);
        return this;
    }
