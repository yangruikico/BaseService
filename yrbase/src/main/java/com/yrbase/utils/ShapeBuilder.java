...
public class ShapeBuilder {
    ...
    public ShapeBuilder stroke(int px, @ColorRes int color) {
        drawable.setStroke(px, ViewUtil.getColor(color));
        return this;
    }

    public ShapeBuilder strokeDp(int dp, @ColorRes int color) {
        drawable.setStroke(ViewUtil.dp2px(dp), ViewUtil.getColor(color));
        return this;
    }
    ...
    public ShapeBuilder stroke(int px, @ColorRes int color, int dashWidth, int dashGap) {
        ...
        drawable.setStroke(px, ViewUtil.getColor(color), dashWidth, dashGap);
        return this;
    }
    ...
    public ShapeBuilder solid(@ColorRes int color) {
        drawable.setColor(ViewUtil.getColor(color));
        return this;
    }
    ...
    public ShapeBuilder radiusDp(float dp) {
        drawable.setCornerRadius(ViewUtil.dp2px(dp));
        return this;
    }
    ...
    private ShapeBuilder gradientInit(GradientDrawable.Orientation orientation, @ColorRes int startColor, @ColorRes int centerColor, int endColor) {
        drawable = new GradientDrawable(orientation, new int[]{ViewUtil.getColor(startColor), ViewUtil.getColor(centerColor), endColor});
        return this;
    }
